...
(defun header-42-enable ()
  ...
  (interactive)
  ;; Add hook to automatically update header on save
  (add-hook 'before-save-hook 'header-42-update nil t)
...
(defun header-42-disable ()
  ...
  (interactive)
  ;; Remove the save hook
  (remove-hook 'before-save-hook 'header-42-update t)
  ;; Remove keybinding
  (if (fboundp 'map!)
      (map! :leader
            (:prefix "c"
